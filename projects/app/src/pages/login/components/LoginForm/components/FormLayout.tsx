...
import { AbsoluteCenter, Box, Button, Flex, Image, Text } from '@chakra-ui/react';
  ...
  return (
    <Flex flexDirection={'column'}>
      <Flex alignItems={'center'}>
        ...
        <Box ml={3} fontSize={['2xl', '6xl']} fontWeight={'bold'} className={styles.font_styles}>
      ...
      <Flex justifyContent={'center'} mt={8}>
        <Image src="/imgs/login/login_bottom.png" w={'75%'} h={'404px'}></Image>
      </Flex>
    </Flex>
  );
};
