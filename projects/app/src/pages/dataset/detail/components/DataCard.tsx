...
const DataCard = () => {
  ...
  return (
    <Box position={'relative'} py={[1, 5]} h={'100%'} bgColor={'white'}>
              ...
              >
                ...
                <CardBody p={0}>
                  <Box
                    ...
                    fontSize={'13px'}
                  >
                    <Box color={'#646a73'} mb={1} lineHeight={2}>
                      {item.q}
                    </Box>
                    <Box color={'#646a73'}>{item.a}</Box>
                  </Box>
                </CardBody>
                <CardFooter pb={0}>
                  <Flex w={'100%'} overflow={'hidden'} alignItems={'flex-end'} fontSize={'sm'}>
                    <Flex alignItems={'center'} color={'#646a73'}>
                      <MyIcon name="common/text/t" w={'14px'} mr={1} color={'myGray.500'} />
                      {item.q.length + (item.a?.length || 0)} 个字符
                    </Flex>
                    <Box flex={1} />
                    {canWrite && (
                      <Flex
                        ...
                        alignItems={'center'}
                        color={'myGray.500'}
                        _hover={{ bgColor: 'myGray.200', color: 'red.500' }}
                        p={1}
                      >
                        <MyIcon
                          name={'delete'}
