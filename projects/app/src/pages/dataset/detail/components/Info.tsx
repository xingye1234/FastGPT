...
const Info = ({ datasetId }: { datasetId: string }) => {
  ...
  return (
    <Box py={5} px={[4, 8]} h={'100%'} display={'flex'} flexDirection={'column'} >
      <Text mb={4} fontWeight={'bold'} fontSize={'lg'}>
        知识库配置
      </Text>
      <Box bgColor={'white'} px={8} py={2} borderRadius={'md'} flexGrow={2}>
            ...
            <AIModelSelector
              ...
              disableTip={
                rebuildingCount > 0 || trainingCount > 0
                  ? datasetT(
                      'The knowledge base has indexes that are being trained or being rebuilt'
                    )
                  : undefined
              }
