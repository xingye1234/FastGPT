...
import { Box, Flex, Grid, useDisclosure, Image, Button, Text } from '@chakra-ui/react';
            ...
            {dataset.type !== DatasetTypeEnum.folder && (
              <Flex alignItems={'center'} fontSize={'sm'}>
                <Flex flex={1} fontSize={'12px'}>
                  <Text>
                    <span style={{ fontWeight: 'bold' }}>{dataset.total}</span> 文档
                  </Text>
                  <Text mx={1} color={'myGray.300'}>
                    |
                  </Text>
                  <Text>
                    <span style={{ fontWeight: 'bold' }}>{dataset.dataAmount}</span> 片段
                  </Text>
